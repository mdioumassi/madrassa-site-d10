...
namespace Drupal\madrassa_registration\Plugin\Action;
...
/**
 * Provides a Fiche action.
 *
 * @Action(
 *   id = "madrassa_registration_fiche",
 *   label = @Translation("Fiche"),
 *   type = "madrassa_registration",
 ...
 */
final class Fiche extends ActionBase {
